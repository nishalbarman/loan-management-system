...
$query_Recordset1 = "SELECT * FROM loan where status='pending'";
    ...
    <center>
        <div class="main">
            <table border="0" align="center" class="responsive-table">
                <h3 class="llTl">Pending loans</h3>
                <tr bgcolor="#33CCFF">
                    <td>Id</td>
                ...
                <?php do { ?>
                    <tr>
                        <td><a href="pendlons.php?recordID=<?php echo $row_Recordset1['loanId']; ?>">
                        ...
                        <td><a href="approveloan.php?loanId=<?php echo $row_Recordset1['loanId']; ?>"
                                style="text-decoration:none">
                                <font color="#3366FF">Action</font>
                            </a></td>
                    </tr>
