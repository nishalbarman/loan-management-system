...
$DetailRS1 = mysqli_query($mlms, $query_limit_DetailRS1);
...
<center>
  <body>
    ...
    <div id="loanhist">
      ...
      <p>loanId<font color="#0099FF">
          <?php echo $row_DetailRS1['loanId']; ?>
        </font>
      </p>
      <p align="justify">ID/passport No<font color="#0099FF">
          <?php echo $row_DetailRS1['memberId']; ?>
        </font>
      </p></br>
      <p align="justify">Amount<font color="#0099FF">
          <?php echo $row_DetailRS1['total_paid']; ?>
        </font>
      </p></br>
      <palign="justify">Monthly pay<font color="#0099FF">
          <?php echo $row_DetailRS1['emi_per_month']; ?>
        </font>
        </p></br>
        <p align="justify">Application date<font color="#0099FF">
            <?php echo $row_DetailRS1['posting_date']; ?>
          </font>
        </p></br>
        <p align="justify">Status<font color="#0099FF">
            <?php echo $row_DetailRS1['status']; ?>
          </font>
        </p></br>
        <p align="justify">Admin remark<font color="#0099FF">
