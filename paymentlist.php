...
$query_DetailRS1 = sprintf("SELECT paymentId, memberId, fName, lName, amount, phone, payment_date FROM payment WHERE paymentId = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
<body>
  ...
  <table border="1" align="center" class="responsive-table">
    <tr>
      <td>paymentId</td>
      <td>
